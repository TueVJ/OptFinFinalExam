...
scalar lambda            '1 - Risk averse, 0 - Risk neutral'
       ...
       M                 'High constant'
       True_budget       'Initial budget to invest in portfolio';
*50 kr. per trade
penalty=50;
*High constant
M=1000000;
* Initial budget was one million - 1000000
True_budget=1000000;
...
his(i,tmonth)=HistoricalMonthlyReturn(i,tmonth);

display HistoricalMonthlyReturn, tmonth;
$offtext
...
equation
         ...
         diflinearweight(i)      'Difference portofolio bound'
...
*$exit
*clearing variables because of initial solotion
...
***************Writing in csv file all the solution for every tmonth
...
display bonds, x_old, x.l, x_difference.l, lambdas;
